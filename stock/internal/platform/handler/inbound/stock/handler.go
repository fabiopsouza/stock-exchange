...
import (
	...
	"github.com/fabiopsouza/stock-exchange/stock/stock/internal/core/service/stock"
	presenter2 "github.com/fabiopsouza/stock-exchange/stock/stock/internal/platform/handler/inbound/presenter"
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		presenter2.BadRequest(w, "Error Binding Request")
		return
	}

	resp, err := h.service.Create(h.ctx, input)
	if err != nil {
		presenter2.InternalError(w, err)
		return
	}

	presenter2.ResponseData(w, resp)
}

func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	symbol, err := getSymbol(r)
	if err != nil {
		presenter2.BadRequest(w, err.Error())
		return
	}
